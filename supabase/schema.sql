...
create index if not exists rooms_hotel_idx on sena_rooms(hotel_id) where is_active;
...
create index if not exists calls_hotel_started_idx on sena_calls(hotel_id, started_at desc);
...
create index if not exists guests_hotel_phone_idx on sena_guests(hotel_id, phone);
...
create index if not exists bookings_room_dates_idx on sena_bookings(room_id, check_in, check_out);
create index if not exists bookings_hotel_status_idx on sena_bookings(hotel_id, status);
...
create index if not exists payments_booking_idx on sena_payments(booking_id);
...
drop trigger if exists bookings_touch on sena_bookings;
create trigger bookings_touch before update on sena_bookings
